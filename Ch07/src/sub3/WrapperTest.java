...
public class WrapperTest {
	...
	public static void main(String[] args) {
		...
		//Wrapper 포장(Boxing)
		Integer box1 = new Integer(var1); ///Deprecate. 17버전에서는 권장되지 않는 방식의 코딩. 
		Double 	box2 = var2;
		Boolean box3 = var3;
		...
		// 문자열 -> Wrapper 변환
		Integer w1 =Integer.valueOf(str1);  ///parseInt써도 되지만! 리턴타입이 이 쪽은 Wrapper다. 
