...
public interface StringTest {
	public static void main(String[] args) {
		...
		//문자열 자르
		String sub1 = msg.substring(0, 5);	///0부터 5 앞까지  
		String sub2 = msg.substring(6);	   ///6부터 마지막까
		
		System.out.println("sub1 : " + sub1);
		System.out.println("sub12: " + sub2);
		
		//문자열 인덱스
		int  idx1 = msg.indexOf("e"); ///앞에서부터 찾기 때문에 인덱스 1이 반환 		
