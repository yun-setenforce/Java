 ...
 * 
 * 예외처리 (Exception)
 *  - 예외는 프로그램 실행주엥 발생하는 모든 에러(Error)
 *  - 실행중(Runtime) 발생하는 예외와 컴파일(CoplieTime)에 발생하는 예외처리
...
public class ExeptionTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			rs3 = num1 * num2;
			rs4 = num1 / num2;
		}catch (ArithmeticException e) { ///ArithmeticExcepiont인데 다형성 적용되어 Exception으로 선언해도 ㅗ딤 
		...
		try {
			...
			//예외처리 발생유무에상관없이 마지막에 항상 실행되는 코드 
